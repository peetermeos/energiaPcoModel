...
Equations
   v_pys_koormus(opt_paev, t_el)         "Kui plokk ei ole töös, siis seda ei koormata."
...
v_pys_koormus(opt_paev, t_el)..
   sum(slott, koorm_el(opt_paev, slott, t_el)) =l= sum((aasta, kuu)$tee_paevaks, p_work(aasta, kuu, t_el))*M
;
