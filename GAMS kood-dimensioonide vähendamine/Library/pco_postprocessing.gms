...
**Tootmine
*Toodangud
  t_production_slot(sim, time_t, slot, t, product)                     "Tootmisüksuse toodang slotis (MWh(el), MWh(sj) või t(õli))"
  t_production_day(sim, time_t, t, product)                            "Tootmisüksuse toodang päevas (MWh(el), MWh(sj) või t(õli))"
  t_production_month(sim, year, quarter, month, t, product)            "Tootmisüksuse toodang kuus (MWh(el), MWh(sj) või t(õli))"
  t_production_tech_month(sim, year, quarter, month, tech, t, product) "Tootmisüksuse toodang tehnoloogiaga kuus (MWh(el), MWh(sj) või t(õli))"
