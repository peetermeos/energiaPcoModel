...
$endif.two
  ...
  v_min_storage_t_m(sim, time_t, s_t)
  ...
  v_min_production_el_m(sim, time_t)
...
v_co2_cert_usage_m(sim, serial, year)                = 0;
v_max_storage_k_m(sim, time_t, s_k)                  = 0;
v_max_storage_t_m(sim, time_t, s_t)                  = 0;
v_min_storage_t_m(sim, time_t, s_t)                  = 0;
...
v_min_production_el_m(sim, time_t)                   = 0;
