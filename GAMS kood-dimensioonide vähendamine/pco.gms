...
$if set manual $set numsim                1000   // Number of stoc.realisations*
...
********************************************************************************
$if set manual $set m_max_marg             363  // Time units for marginals    *
...
$if set manual $if     set nk  execute_unload '%n_source% %nk% %beg_year% noudluskover.gdx';
$if set manual $if     set nkl execute_unload '%n_source% %nk% %beg_year% noudluskover.gdx';
