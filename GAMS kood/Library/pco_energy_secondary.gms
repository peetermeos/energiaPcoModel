...
sale_contract_s(sim, t_mk, k, feedstock, year, month)$(sum(time_t$y_m_t, 1) > 0) = sale_contract(t_mk, k, feedstock, year, month);
...
el_price_slot_s("1", time_t, slot) = el_price_slot(time_t, slot);
