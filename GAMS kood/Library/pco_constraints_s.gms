...
* Additional constraint for equalising mine production inside years
$ifthen.two "%even_mining%" == "true"
  v_k_even_mining(year, month, k)                   "Mining equalised over months in given year"
$endif.two
;
...
********************************************************************************
$ifthen.two "%even_mining%" == "true"
  v_k_even_mining(year, month, k)..

   (
   max_mining_cap(k, feedstock, year, month2)
   -
   amount mined()
   )
   -
...
* Daily maximal amount must be divided by working days in given month
   (sum((year, month2)$date_cal(time_t, year, month2), max_mining_cap(k, feedstock, year, month2)
                          / monthly_workdays(year, month2, k))
   )$(sum((year, month2)$ydate_cal(time_t, year, month2), monthly_workdays(year, month2, k) > 0))
