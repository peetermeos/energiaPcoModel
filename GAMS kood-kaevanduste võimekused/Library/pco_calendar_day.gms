...
*$macro days_in_month_l(year, month) (days_in_month(month) + gleap(jdate(first_year + ord(year) - 1, ord(month), 1))$(ord(month) = 2))
$macro days_in_month_l(year, month) (days_in_month(month) + gleap(jdate(%year_1% + ord(year) - 1, ord(month), 1))$(ord(month) = 2))
$macro days_in_month_m(year, month) (days_in_month(month) + gleap(jdate(%year_1% + ord(year) - 1, ord(month), 1))$(ord(month) = 2))


$macro days_in_t(time_t) 1
$macro disc_periods 365
